...
if (!class_exists('Address', false)) {
    class Address
    {
        ...
        public function getEncodedAddress(): string { return $this->address; }
...
if (!class_exists('Email', false)) {
    class Email
    {
        ...
        public function from(Address $a): self { $this->from = [$a]; return $this; }
        public function getFrom(): array { return $this->from; }
        public function to(Address ...$a): self { $this->to = $a; return $this; }
        public function getTo(): array { return $this->to; }
        public function cc(Address ...$a): self { $this->cc = $a; return $this; }
        public function getCc(): array { return $this->cc; }
        public function bcc(Address ...$a): self { $this->bcc = $a; return $this; }
        public function getBcc(): array { return $this->bcc; }
        public function replyTo(Address ...$a): self { $this->replyTo = $a; return $this; }
        public function getReplyTo(): array { return $this->replyTo; }
        public function text(string $t): self { $this->textBody = $t; return $this; }
        public function getTextBody(): ?string { return $this->textBody; }
        public function html(string $h): self { $this->htmlBody = $h; return $this; }
        public function getHtmlBody(): ?string { return $this->htmlBody; }
        public function returnPath(Address $a): self { $this->returnPath = $a; return $this; }
        public function getReturnPath(): ?Address { return $this->returnPath; }
        public function getHeaders(): object { return $this->headers; }
    }
}
...
class FakeSesClient extends SesClient
{
    ...
    public function setSendResponse(SendEmailResponse $r): void { $this->response = $r; }
    public function setSendException(\Exception $e): void { $this->sendException = $e; }
    public function setPingException(\Exception $e): void { $this->pingException = $e; }
...
class Swift_Transport_Api_AmazonSesApiTransportTest extends TestCase
{
    ...
    {
        $e = $this->makeEmail();
        $h = new class { public function getBodyAsString(): string { return 'my-config-set'; } };
    ...
    {
        $e = $this->makeEmail();
        $h = new class { public function getBodyAsString(): string { return 'arn:aws:ses:us-east-1:123:identity/x'; } };
    ...
    {
        $e = $this->makeEmail();
        $h = new class { public function getBodyAsString(): string { return 'contactListName=MyList; topicName=MyTopic'; } };
